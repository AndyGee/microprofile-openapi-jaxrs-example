...
import org.example.microprofile.api.beans.idm.UserPermissionsBean;
import org.example.microprofile.api.rest.contract.IPermissionsResource;
...
public class PermissionsResourceImpl implements IPermissionsResource {
    ...
    /**
     * @see org.example.microprofile.api.rest.contract.IPermissionsResource#getPermissionsForUser(java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.example.microprofile.api.rest.contract.IPermissionsResource#getPermissionsForCurrentUser()
     */
    @Override
